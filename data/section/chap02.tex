...
\begin{figure}[H] % use float package if you want it here
  \centering
  \bicaption{利用 Xfig 制图}{Image with Xfig}
  \label{fig:xfig1}
\end{figure}
...
\begin{figure}[h]
  \centering%
  \bisubcaptionbox{第一个小图形\label{fig:subfig1}}{The First Figure}
  [3cm] %标题的长度，超过则会换行，如下一个小图。
    {\includegraphics[height=3cm]{thu-fig-logo}}
      \hspace{4em}% 这里记得不要空行，否则会变为垂直的两个图
  \bisubcaptionbox{第二个小图形，注意这个图略矮些。如果标题很长的话，它会自动换行\label{fig:subfig2}}{The Second Figure}
      {\includegraphics[height=2cm]{thu-text-logo}}
  \bicaption{包含子图形的大图形(subcaptionbox示例)}{Large Figure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{3cm}
    \includegraphics[height=3cm]{thu-fig-logo}
    \bicaption{第一个小图形}{The first Small Figure}
  \end{subfigure}
  \hspace{4em}%
  \begin{subfigure}{0.5\textwidth}
    \includegraphics[height=2cm]{thu-text-logo}
    \bicaption{第二个小图形，注意这个图略矮些。subfigure中同一行的子图在顶端对齐。}{The Second Small Figure}
  \end{subfigure}
  \bicaption{包含子图形的大图形(subfigure示例)}{Big Figure}
...
\begin{minipage}{0.48\textwidth}
  ...
  \bicaption{并排第一个图}{The First Figure}
  \label{fig:parallel1}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[height=2cm]{thu-whole-logo}
  \bicaption{并排第二个图}{The Second Figure}
  \label{fig:parallel2}
\end{minipage}
\end{figure}
